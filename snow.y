...
%token TOKEN_EQUAL TOKEN_PLUS TOKEN_SUB TOKEN_TIMES TOKEN_DIVIDE TOKEN_POINT
...
%token TOKEN_AND TOKEN_OR TOKEN_BROKEN_ISSUE TOKEN_AT TOKEN_EXCLAMATION TOKEN_HASHTAG TOKEN_DOLLAR TOKEN_PERCENT TOKEN_START TOKEN_COLON TOKEN_SEMICOLON
